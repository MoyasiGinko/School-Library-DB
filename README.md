...
```sh
  cd my-folder
  git clone https://github.com/MoyasiGinko/School-Library-DB.git
```
...
Feel free to check the [issues page](https://github.com/MoyasiGinko/School-Library-DB/issues)
